/*Que. You need to write a function findTax() that takes a number type variable as an argument which is the salary of a person. Add commentMore actions
...
function findTax(salary) {Add commentMore actions
  let tax;
